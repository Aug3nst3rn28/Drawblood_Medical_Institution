import 'package:drawblood_medicalinstitution_app/drawblood_app/ui_view/appointment_history_view.dart';
...
class AppointmentScreen extends StatefulWidget {
  const AppointmentScreen({Key? key, this.animationController})
      : super(key: key);
